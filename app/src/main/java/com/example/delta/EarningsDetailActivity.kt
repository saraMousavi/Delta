...
var NEED_REFRESH_EARNING: Boolean = false
            ...
            object : OnBackPressedCallback(true) {
                override fun handleOnBackPressed() {
                    val resultIntent = Intent().apply {
                        putExtra("NEED_REFRESH_EARNING", NEED_REFRESH_EARNING)
                    }
...
//            modifier = Modifier.padding(8.dp)
            ...
            LazyColumn(
                ...
                item {
                    ...
                    val allSelected =
                        selectedCredits.size == selectableCredits.size && selectableCredits.isNotEmpty()
                    ...
                    Row(
                        ...
                        Checkbox(
                            ...
                            onCheckedChange = { checked ->
                                if (checked) {
                                    viewModel.setSelectedCredits(selectableCredits.map { it.creditsId }
                                        .toSet())
                                } else {
